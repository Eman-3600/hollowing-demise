...
public class ModItems {
    ...
    public static final Item SOULROOT_BULB = register("soulroot_bulb", (settings) -> new EssenceFoodItem(settings, SoulComponent.SOUL_PER_VESSEL * 3 / 2, 9), new Item.Settings().food(SOUL_BERRY_FOOD));
    ...
    public static final Item ALMARITE_TUNNELER = register("almarite_tunneler", settings -> new TunnelerItem(ModToolMaterials.ALMARITE, 2.5f, -3f, settings), new Item.Settings().component(ModDataComponentTypes.TOOLTIP_LINES, 2));
