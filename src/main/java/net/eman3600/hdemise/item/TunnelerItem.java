...
public class TunnelerItem extends Item {
    public TunnelerItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
        super(settings.tool(material, ModTags.Blocks.TUNNELER_MINEABLE, attackDamage, attackSpeed, 0));
    }
